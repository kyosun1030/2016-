...
////// Emissive:
                ...
                float3 emissive = lerp(node_59.rgb,lerp(((node_142+node_130+node_128+node_131)/13.0),((0.025*node_142)+(0.05*node_130)+(0.075*node_128)+(0.4*node_131)),_Bias),saturate(node_185));
